    ...
    <div class="container">
      <div class="middle">
        ...
        <table class="portraits">
          <tr> <!--Portraits-->
            <!--Tardos-->  
            <td><a href="#Tardos"><img src="img/portraits/Tardos.jpg" height="250" width="200"></a></td>
          </tr>
            
          <tr class="name"> <!--Names-->
            <td><a href="#Tardos">Professor &#201;va Tardos</a></td>
          </tr>
          
          </table>

<!-- Not sure what broke here? Commenting out some of the parts for now. -Inyoung -->
        
<!--Portraits Content-->
<!-- <div id="Tardos" class="modal"> -->
    <div>
		<!-- <div align="right"><a href="#close" class="close">Close</a></div><bR> -->
		<h2 style="top:0px;">&#201;va Tardos</h2>
		<h4 style="margin-bottom:5px;">Professor of Computer Science</h4>
        <!-- <img class="portrait" src="img/portraits/Tardos.jpg" width="320" height="400"> -->
        <div class="qanda">
        <p>
        <ol class="questions">
