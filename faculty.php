      ...
      <div class="container">
        <div class="narrow">
            ...
            <div class="profile row">
              <div class="col-sm-4 c">
                <div class="square_image">
                  <img src="img/faculty/Morrisett.jpg">
                </div>
                <div class="name">Greg Morrisett</div>
                <div class="class">Dean of Computing and Information Science</div>
              </div>
              <div class="col-sm-8 info">
                <h3>Greg Morrisett</h3>
                <p>
                  Greg Morrisett is the Dean of Computing and Information Science (CIS) at Cornell University, which houses the departments of Computer Science, Information Science, and Statistical Sciences. Dean Morrisett started his academic career in Cornell’s Computer Science department, and then took a brief (12 year) sabbatical at Harvard before returning in 2015.
                </p><br>
                <p>
          ...
          <div class="profile row">
            <div class="col-sm-4 c">
              <div class="square_image s2">
                <img src="img/faculty/Bracy.jpg">
              </div>
              <div class="name">Anne Bracy</div>
              <div class="class">Senior Lecturer</div>
            </div>
            <div class="col-sm-8 info">
              <h3>Anne Bracy</h3>
              <p>
                I am a Senior Lecturer in the computer science department. I obtained a BS in Symbolic Systems and an MS in Computer Science from Stanford University and a PhD in Computer Science at the University of Pennsylvania. I teach primarily undergraduate systems courses. Prior to my arrival at Cornell, I was a Principal Lecturer at Washington University in St. Louis. I was also a Research Scientist at the Microarchitecture Research Lab at Intel Labs in Santa Clara, California. In addition to being a member of WICC’s Faculty Board I am also a 2016 participant of the Faculty Institute for Diversity.
              </p><br>
              <p>I support diversity in technology because I love computer science. Everyone should have an equal opportunity to participate fully in this stimulating field. Furthermore, a wider range of perspectives and backgrounds naturally yields more innovative ideas and wider applications. Increasing the diversity of computer scientists improves computer science.
              </p>
            </div>
          </div>
          ...
          <div class="profile row">
            <div class="col-sm-4 c">
              <div class="square_image s2">
                <img src="img/faculty/Tardos.jpg">
              </div>
                <div class="name">Eva Tardos</div>
                <div class="class">Professor</div>
             </div>
            <div class="col-sm-8 info">
              <h3>Eva Tardos</h3>
              <p>
                Eva Tardos is the Jacob Gould Schurman Professor of Computer Science and Information Science at Cornell. Her research focuses on Algorithm Design and the interface of Computing and Economics, with an emphasis on algorithms and games on networks. She is a member of the National Academy of Engineering and National Academy of Sciences. Tardos received her PhD in from Eötvös University, Budapest, Hungary. She did a series of postdocs and short term positions in computer science including time spent at Berkeley and MIT, and has been a faculty member at Cornell since 1989. 
              </p><br>
              <p>
                She has been the faculty advisor for the Women in Computing at Cornell since its inception, and though WICC’s helped encourage many more women to choose CS major. She earned her PhD in 1984, the year that had most women in computing (see for example, the charts in <a href="http://www.npr.org/sections/money/2014/10/21/357629765/when-women-stopped-coding" target="_blank">this</a> article for trends in percentage of women in computing). With the help of WICC, the percentage of women in CS at Cornell grew to currently over 25% from barely 10% not so many years ago. She is very proud of WICC for all the group has done to make CS a better major for women, and committed to continue this work, hoping to bring the percentage of women in CS at Cornell up to at least what it was nationally in the early eighties.
              </p>
            </div>
          </div>
